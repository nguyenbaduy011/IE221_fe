...
export default function MasterDataLayout({
  ...
  const tabs = [
    {
      name: "Subjects",
      href: "/supervisor/master-data/subjects",
      icon: BookOpen,
    },
    {
      name: "Tasks",
      href: "/supervisor/master-data/tasks",
      icon: CheckSquare,
    },
    {
      name: "Categories",
      href: "/supervisor/master-data/categories",
      icon: Tag,
    },
  ];
      ...
      <div className="space-y-6 border-b border-border pb-1">
        <div className="flex flex-col space-y-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            Configure subjects, tasks, and categories for your training
            programs.
          </p>
        </div>
